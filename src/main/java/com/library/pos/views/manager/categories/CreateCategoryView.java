...
/**
 * CreateCategoryView - Form for creating new category
 */
public class CreateCategoryView extends JDialog {
    ...
    public CreateCategoryView(IndexCategoryView parent) {
        super(JOptionPane.getFrameForComponent(parent), "Add New Category", true);
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel lblTitle = new JLabel("ADD NEW CATEGORY");
    ...
    private JPanel createInfoPanel() {
        ...
        JLabel lblInfo = new JLabel("Add New Category");
        lblInfo.setFont(new Font("Segoe UI", Font.BOLD, 13));
        lblInfo.setForeground(new Color(39, 174, 96));

        JLabel lblDetail = new JLabel("<html>Create a new category for organizing books. Category name must be unique.</html>");
