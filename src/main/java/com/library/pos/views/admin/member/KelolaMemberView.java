        ...
        public ActionButtonEditor(JCheckBox checkBox) {
            ...
            btnEdit.addActionListener(e -> {
                ...
                if (row != -1) {
                    ...
                    EditMemberView editView = new EditMemberView(KelolaMemberView.this, id, code, name, age, phone,
                            address);
            ...
            btnDelete.addActionListener(e -> {
                fireEditingStopped();
                int confirm = JOptionPane.showConfirmDialog(panel, "Hapus member ini?", "Hapus",
