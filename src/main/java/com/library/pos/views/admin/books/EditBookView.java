package com.library.pos.views.admin.books;
...
/**
 * EditBookView - Form for editing existing book
 */
public class EditBookView extends JDialog {
    ...
    public EditBookView(IndexBookView parent, Book book) {
        super(JOptionPane.getFrameForComponent(parent), "Edit Book", true);
    ...
    private JPanel createInfoPanel() {
        ...
        JLabel lblInfo = new JLabel("Edit Book ID: " + book.getId());
        lblInfo.setFont(new Font("Segoe UI", Font.BOLD, 13));
        lblInfo.setForeground(new Color(41, 128, 185));

        JLabel lblDetail = new JLabel("<html>Update book data. Title and Stock are required fields. ISBN and ISSN must be unique.</html>");
    ...
    private void loadBookData() {
        txtIsbn.setText(book.getIsbn() != null ? book.getIsbn() : "");
        txtIssn.setText(book.getIssn() != null ? book.getIssn() : "");
        txtTitle.setText(book.getTitle());
        txtAuthor.setText(book.getAuthor() != null ? book.getAuthor() : "");
        txtPublisher.setText(book.getPublisher() != null ? book.getPublisher() : "");
        txtPages.setText(book.getNumberOfPages() != null ? book.getNumberOfPages().toString() : "");
        txtGenre.setText(book.getGenre() != null ? book.getGenre() : "");
        txtLanguage.setText(book.getLanguage() != null ? book.getLanguage() : "");
        txtPublicationPlace.setText(book.getPublicationPlace() != null ? book.getPublicationPlace() : "");
        txtYear.setText(book.getYear() != null ? book.getYear().toString() : "");
