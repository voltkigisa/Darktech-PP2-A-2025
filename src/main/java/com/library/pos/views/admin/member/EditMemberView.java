...
public class EditMemberView extends JDialog {
    ...
    public EditMemberView(KelolaMemberView parent, int id, String code, String name, String age, String phone, String address) {
    ...
    private JPanel createInfoPanel() {
        ...
        JLabel lblDetail = new JLabel("<html>Modify the record for this library member. All fields are required.</html>");
