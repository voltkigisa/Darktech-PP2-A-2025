...
/**
 * ShowCategoryView - Detail view for a single Category
 */
public class ShowCategoryView extends JDialog {
    ...
    public ShowCategoryView(IndexCategoryView parent, Category category) {
        super(JOptionPane.getFrameForComponent(parent), "Category Details", true);
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel lblTitle = new JLabel("CATEGORY DETAILS");
    ...
    private JPanel createDetailPanel() {
        ...
        JLabel iconLabel = new JLabel("CATEGORY");
        ...
        // Detail fields
        detailContainer.add(createDetailField("ID", String.valueOf(category.getId())));
        detailContainer.add(Box.createRigidArea(new Dimension(0, 15)));

        detailContainer.add(createDetailField("Category Name", category.getName()));
        detailContainer.add(Box.createRigidArea(new Dimension(0, 15)));
    ...
    private JPanel createButtonPanel() {
        ...
        btnEdit.addActionListener(e -> {
            dispose();
            EditCategoryView editView = new EditCategoryView(parentView, category);
