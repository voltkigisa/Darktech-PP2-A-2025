...
/**
 * LihatBukuView - View untuk melihat daftar buku
 */
public class LihatBukuView extends JPanel {
    private final User currentUser;
    private Runnable onBackCallback;

    public LihatBukuView(User currentUser) {
    ...
    private void initComponents() {
        ...
        JLabel descLabel = new JLabel("Lihat daftar buku yang tersedia");
        ...
        JLabel infoLabel = new JLabel("Fitur lihat buku sedang dalam pengembangan");
