...
/**
 * LihatAnggotaView - View untuk melihat data anggota
 */
public class LihatAnggotaView extends JPanel {
    private final User currentUser;
    private Runnable onBackCallback;

    public LihatAnggotaView(User currentUser) {
    ...
    private void initComponents() {
        ...
        JLabel descLabel = new JLabel("Lihat data anggota perpustakaan");
        ...
        JLabel infoLabel = new JLabel("Fitur lihat anggota sedang dalam pengembangan");
